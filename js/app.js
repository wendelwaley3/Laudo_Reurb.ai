...
<body>
    ...
    <main>
        ...
        <section id="upload" class="container">
            ...
            <div class="upload-area">
                <label for="geojsonFileInput" class="drag-drop-area">
                    ...
                    <button type="button" id="selectFilesVisibleButton">Selecionar Arquivos</button>
                </label>
            ...
            <!-- CONTROLE DE REPROJEÇÃO UTM (ESSENCIAL PARA O JS FUNCIONAR) -->
            <div id="utmConversionSettings" style="margin-top:20px; padding:15px; background-color:#eef4f7; border-radius:8px;">
                ...
                <div style="display:flex; flex-wrap:wrap; gap:15px; align-items:center;">
                    ...
                    <div id="utmOptionsContainer" style="display:none; flex-wrap:wrap; gap:10px; align-items:center;">
                ...
                <p style="font-size:0.85em; color:#666; margin-top:10px;">
                    <strong>Atenção:</strong> É altamente recomendado que seus arquivos GeoJSON já estejam em Latitude/Longitude (WGS84 - EPSG:4326) para melhor precisão e desempenho. Use esta opção apenas se não puder converter previamente.
                </p>
            </div>
        </section>
        ...
        <!-- ... (resto das seções Relatórios e Instruções permanecem as mesmas) ... -->
