...
function initMap() {
    ...
    // O 'toggleLotes' está marcado por padrão no HTML, então a camada de lotes deve ser adicionada
...
function refreshDashboard() {
    ...
    // REMOVER ESTA PARTE PARA NÃO EXIBIR O MUNICÍPIO PRINCIPAL NO DASHBOARD
    // document.getElementById('mainMunicipioDisplay').textContent = 'N/A'; // Define como N/A sempre
}
// ===================== Tabela de Lotes =====================
